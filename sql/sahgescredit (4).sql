...
--
-- Client :  127.0.0.1
-- Généré le :  Sam 13 Février 2016 à 16:12
...
(84, 'BIEN', 'VNHU', 'SOUSCRIPTION', 1, 'Orabanque', 2, 'Agence Saint Michel Ora', 'DOSSOU', 'Michel', '2016-02-12', 'M', 'Soudeur', 12636205, '2015-09-04', '5', '2016-07-04', 0, 'UNIQUE', 'mensuelle', 6, 'non', 'a terme', 0, 1500, NULL, NULL, NULL, NULL, 17, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'insert'),
(85, 'BOUBLE3', 'WZZ', 'SOUSCRIPTION', 1, 'Orabanque', 1, 'Agence Gahi Ora', 'BONJOUR', 'Sourou', '2013-02-12', 'M', 'MILITAIRE', 12632015, '2015-11-04', '3', '2016-05-04', 3, 'ANNNUEL', 'mensuelle', 7, 'non', 'a terme', 0, 1500, NULL, NULL, NULL, NULL, 17, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'insert'),
...
(87, 'BBVFUO16', '1236', 'ANNULATION', 2, 'BIBE', 3, 'Agence Saint Michel BIBE', 'BOUNCE', 'Jean', '2016-02-12', 'F', 'Founisseur', 5201236, '2015-09-04', '5', '2016-02-04', 0, 'UNIQUE', 'mensuelle', 12, 'non', 'periodique', 0, 1500, NULL, NULL, NULL, NULL, 17, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'insert');
...
(2, 2, 1, 'consultation', 1),
(3, 3, 1, 'consultation', 1),
(44, 2, 3, 'consultation', 1),
(45, 31, 2, 'modification', 1),
(46, 35, 2, 'consultation', 1),
(47, 3, 2, 'ecriture', 1),
(51, 10, 3, 'ecriture', 0),
(49, 1, 2, 'modification', 1),
(50, 35, 3, 'ecriture', 1),
(59, 1, 24, 'consultation', 1),
(60, 2, 24, 'consultation', 1),
(61, 3, 24, 'modification', 0),
(62, 10, 24, 'consultation', 1),
(63, 31, 24, 'consultation', 1),
(64, 35, 24, 'modification', 0),
(65, 35, 24, 'ecriture', 0),
(78, 35, 26, 'consultation', 0),
(77, 31, 26, 'consultation', 0),
(76, 10, 26, 'consultation', 0),
(75, 3, 26, 'ecriture', 1),
(74, 2, 26, 'consultation', 0),
(73, 1, 26, 'consultation', 0),
(79, 35, 26, 'ecriture', 1);
...
(13, 'mpoooopp', 'fa fa-circle-o-notch'),
...
--
-- Déclencheurs `nomgroupeutilisteur`
--
DROP TRIGGER IF EXISTS `DroitProfil`;
DELIMITER //
CREATE TRIGGER `DroitProfil` AFTER INSERT ON `nomgroupeutilisteur`
 FOR EACH ROW BEGIN
...
DELIMITER //
CREATE TRIGGER `supprime_profil` BEFORE DELETE ON `nomgroupeutilisteur`
 FOR EACH ROW BEGIN
...
(17, 'Gael', 'Gael', 'Amoussouvi', 'M', 69699588, 'Travail', 'gael@yahoo.fr', '$2a$10$db1a01017f53d72861f17ucz1nufv1RLX9H4ZRqMLLJGCZsGdRAsK', 'Actif', '2016-02-13 15:12:00', '2016-01-05 09:17:19', 2, 1, 2, 'banque', 'modification'),
...
(22, 'Aldo', 'Dossou', 'Romuald', 'M', 13456, 'Professeur', 'aldo@yahoo.fr', '$2a$10$5d5ae24af1f6ffa123735u.vp9zinSotFqBJQnbtvFaHc.bNQg0E6', 'Actif', '2016-02-12 10:35:00', '2016-02-01 12:27:01', 1, 3, 6, 'banque', 'modification'),
(23, 'Pelagie', 'Mondou', 'Pelagie', 'M', 96993612, 'Professeur', 'pepe@yahoo.fr', '$2a$10$f8ba0a30bfa3daf13790euNCRlK45fyhckr4REnAOBJ.iD0KHrWCG', 'Actif', '2016-02-09 17:42:00', '2016-02-02 09:06:47', 2, 3, 5, 'agence', 'modification'),
...
(30, 'Patric', 'SONAGNON', 'Patric', 'M', 98653212, 'Programmeur', 'patric@yahoo.fr', '$2a$10$b73e1c0ee45fb49fa48d7OE.3NdlrlUBpEGIPBOuzgScjdya97Ct6', 'Actif', '2016-02-09 18:45:00', '2016-02-09 17:06:22', 2, 4, 8, 'banque', NULL),
(31, 'Gregoire', 'BOSSOKPO', 'Gregoire', 'M', 98652323, 'Comptable', 'greg@yahoo.fr', 'sahgescredit', 'Actif', '2016-02-11 18:31:00', '2016-02-11 17:31:29', 22, 2, 4, 'agence', NULL),
(32, 'fritz', 'TOTIN', 'Fritz', 'M', 98653212, 'Analyste', 'fritz.totin@sahamassurance.com', 'sahgescredit', 'Actif', '2016-02-13 12:41:00', '2016-02-13 11:41:49', 1, 3, 5, 'banque', NULL);
